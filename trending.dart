...
// Calling top headlines or trending from newsapi
  Future<String> getData() async {
    String url1 =
        "https://newsapi.org/v2/everything?q=energy&apiKey=6d30dc9ab3d24cbd925ae5e4979369fa";
  ...
  Future<String> getAllData() async {
    String url2 =
        "https://newsapi.org/v2/everything?domains=www.nation.co.ke&language=en&apiKey=6d30dc9ab3d24cbd925ae5e4979369fa";
    http.Response response = await http
          ...
          children: <Widget>[
            TabBarView(
              children: <Widget>[
                ...
                // // Building list of all news from all news[] list
                ListView.builder(
